...
export default class Curve {
  constructor(coords) {
    ...
    const materialDestination = new THREE.MeshBasicMaterial(Materials.pointOfDestination);
  ...
  animate(currentCurveStep, material) {
    ...
    this._affectMeshes([this.meshDestination.scale, this.meshOrigin.scale], this.scale);
    ...
    if (currentCurveStep >= CURVE_SEGMENTS) {
      ...
      this._affectMeshes([this.meshDestination.scale, this.meshOrigin.scale], MESH_DEFAULT_SCALE);
    }
