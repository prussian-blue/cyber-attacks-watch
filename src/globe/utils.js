...
export function getSplineFromCoords(coords) {
  ...
  const mid1 = coordinateToPosition(midCoord1[1], midCoord1[0], PLANET_RADIUS + altitude);
  const mid2 = coordinateToPosition(midCoord2[1], midCoord2[0], PLANET_RADIUS + altitude);
